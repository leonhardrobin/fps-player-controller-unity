...
public class ControllerDebugger : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(50f, 50f, 200f, 20f), $"H: {horVel:F}");
        GUI.Label(new Rect(50f, 80f, 200f, 20f), $"^H: {_topSpeedHorizontal:F}");
        GUI.Label(new Rect(50f, 110f, 200f, 20f), $"V: {verVel:F}");
        GUI.Label(new Rect(50f, 140f, 200f, 20f), $"^V: {_topSpeedVertical:F}");
    }
}